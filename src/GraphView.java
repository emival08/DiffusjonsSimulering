...
/**
 * The java.app.GraphViewView provides a view of two populations of actors in the field as a line graph
...
public class GraphView implements SimulatorView {
     ...
     *
     * @param agentClass The animal's Class object.
     * @param color       The color to be used for the given class.
     */
    public void setColor(Class<?> agentClass, Color color) {
        colors.put(agentClass, color);
    ...
    class GraphPanel extends JComponent {
        ...
        public void update(int step, Field field, FieldStats stats) {
            if (classes.size() >= 2) {
                ...
                stats.reset();
                count1 = stats.getPopulationCount(field, class1);
                count2 = stats.getPopulationCount(field, class2);
